...
<body <?php body_class(); ?>>
	...
	<div id="top-header">
	<div class="top_logo">
				<a href="<?php echo get_home_url(); ?>"><img src="<?php echo get_bloginfo('template_url') ?>/images/logo-final.png"  width="<?php echo get_custom_header()->width; ?>" height="<?php echo get_custom_header()->height; ?>" /></a> 
			</div>
			<div class="fullwidth-current-date"><?php echo date_i18n('l, j F, Y'); ?></div>
		...
		<?php DISPLAY_ACURAX_ICONS(); ?>
			...
			<div id="search-form">
				<form method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>/">
					...
					<div class="dashicons dashicons-search" id="searchsubmit"></div>
				</form>
			</div> <!-- end #search-form -->
